...
func _main (args []*string) (_err error) {
	...
	sendSmsRequest := &dysmsapi20170525.SendSmsRequest{
		PhoneNumbers: tea.String("15828343746"),
		SignName: tea.String("杰布斯爱编程"),
		TemplateCode: tea.String("SMS_277450714"),
		TemplateParam: tea.String("{\"code\":\"1028\"}"),
	}
	...
	tryErr := func()(_e error) {
		...
		rsp, _err := client.SendSmsWithOptions(sendSmsRequest, runtime)
		if _err != nil {
			return _err
		}
		fmt.Printf("rsp: %v\n", *rsp)
